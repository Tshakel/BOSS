...
msg.TheRank = redis:get(boss..":RtbaNew2:"..msg.chat_id_) or 'مطور'
msg.Rank = 2
...
{{text="الاغاني",callback_data="/HelpListDev"..UserID},{text="م5",callback_data="/HelpListRrd"..UserID}},
